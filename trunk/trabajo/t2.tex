...
zumos, sangría o incluso tinto de verano, dependendiendo de las necesidades y
la época del año. Es decir en general cualquier producto de Don Simón que
esté envasado en botella de plástico. 
...
\item Después los grupos de botellas pasan a otra máquina llamada
  ...
  encima de otros, y todos ellos encima de un palet para facilitar su
  transporte.
\item Finalmente el palet de botellas pasa hacia la \textbf{Enfardadora}
...
el transporte de una a la siguiente tambien está automatizado mediante diversas
cintas transportadoras. Pero de todo esto se habla más a fondo en el capítulo siguiente.
