...
controlador, en un PC. Los PCs empleados tienen el S.O. Windows XP (Embedded) y
un software \textbf{SCADA}, proporcionado por el fabricante de la máquina,
llamado \emph{ZENON}, desarrollado por \emph{COPA-DATA}. La comunicación entre 
PC y PLC se desarrolla por Ethernet, aunque también puede hacerse mediante 
R232.
