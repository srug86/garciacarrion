...
JGC para desarrollar su plan estratégico cuenta con distintas bodegas y 
...
\item Seguidamente, las botellas son conducidas hacia la \textbf{Agrupadora}
  que, como su nombre indica, que encarga de agrupar packs de cuatro botellas,
forrándolas en plástico, de forma que su futura manipulación sea por 
conjuntos, no de forma individual.
...
Esta planta dispone de una sopladora \emph{KRONES Volumetic}, con una capacidad
de trabajo de más de 14.000 botellas a la hora.
...
Con la ayuda de un controlador PID (Proporcional Integral Derivativo), la 
temperatura que se aplica a la preforma se mantiene en todo momento constante, 
ya que de no ser así, puede provocarle deformaciones.
...
una serie de rodillos que seguidamente comentaremos: 
\begin{itemize}
 \item tenemos dos rodillos que contienen dos bobinas de etiquetas, una que va
suministrando las etiquetas y la otra que está para cuando se termine el 
...
debe cortar la etiqueta. Esta fotocélula, coordinada con un encoder, avisa de
cuándo debe actuar la cortadora del rodillo sobre la etiqueta.
...
que ocurría con la llenadora/taponadora contamos con otro \textbf{pusher}
que, ayudado de un encoder, expulsará las botellas que no cumplan los
...
Los palés completados son recogidos por vehículos guiados automáticamente, o
AGVs, para ser transportados hacia nuestra siguiente y última isla de 
automatización, la enfardadora.
...
Al igual que la anterior, este sistema tampoco es KRONES, sino ELETTRIC80.
